            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            {{ $t->user_profile->family_name }}, 
                            {{ $t->user_profile->given_name }} {{ $t->user_profile->ext_name}}
                        ...
                        <td>
                            ...
                            {{--  <button class="btn btn-danger btn-sm" data-subid="{{ $t->subject_id }}" data-toggle="modal" data-target="#deleteSubject" {{ $t->classe->count() > 0 ? 'disabled' : '' }}>Delete</button>  --}}
                        </td>
                    </tr>
