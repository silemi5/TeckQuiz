@extends('layouts.app') @section('title', 'Manage class - TeckQuiz') @section('content')
<style>
    body {
        padding-top: 70px;
    }
                        ...
                        <div class="col-3">
                            <div class="card text-white bg-primary">
                                <div class="card-body">
                                    ...
                                    <p class="text-center"> Quiz{{ $quiz_events->count()
                                        <=1 ? '' : 'zes' }}</p>
                                </div>
                        ...
                        <div class="col-3">
                            <div class="card text-white bg-success">
                                <div class="card-body">
                                    ...
                                    <p class="text-center"> Student{{ $quiz_events->count()
                                        < 1 ? '' : 's' }}</p>
                                    </div>
